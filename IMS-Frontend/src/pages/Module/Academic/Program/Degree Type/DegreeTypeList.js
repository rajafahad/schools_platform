...
import EditClassModal from "./EditDegreeTypeModal";
import AddClassModal from "./AddDegreeTypeModal";
...
const DegreeTypeList = () => {
  ...
  useEffect(() => {
    useApi.get("api/degreetype").then((response) => {
      ...
      cell: (row) => (
        <div className="tb-odr-btns">
          ...
          <Button
            ...
            onClick={() => deleteModal("api/degreetype/", row._id, updateData)}
          >
