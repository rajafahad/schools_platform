...
import EditClassModal from "./EditSessionModal";
import AddClassModal from "./AddSessionModal";
...
const SessionList = () => {
  ...
  useEffect(() => {
    useApi.get("api/session").then((response) => {
      ...
      cell: (row) => (
        <div className="tb-odr-btns">
          ...
          <Button
            ...
            onClick={() => deleteModal("api/session/", row._id, updateData)}
          >
