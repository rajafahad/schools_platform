...
import EditClassModal from "./EditLevelModal";
import AddClassModal from "./AddLevelModal";
...
const LevelList = () => {
  ...
  useEffect(() => {
    useApi.get("api/level").then((response) => {
      ...
      cell: (row) => (
        <div className="tb-odr-btns">
          ...
          <Button
            ...
            onClick={() => deleteModal("api/level/", row._id, updateData)}
          >
