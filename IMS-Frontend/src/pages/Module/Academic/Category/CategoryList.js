...
import EditClassModal from "./EditCategoryModal";
import AddClassModal from "./AddCategoryModal";
...
const CategoryList = () => {
  ...
  useEffect(() => {
    useApi.get("api/category").then((response) => {
      ...
      cell: (row) => (
        <div className="tb-odr-btns">
          ...
          <Button
            ...
            onClick={() => deleteModal("api/category/", row._id, updateData)}
          >
