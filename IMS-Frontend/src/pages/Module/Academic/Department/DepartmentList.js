...
import EditClassModal from "./EditDepartmentModal";
import AddClassModal from "./AddDepartmentModal";
...
const DepartmentList = () => {
  ...
  useEffect(() => {
    useApi.get("api/department").then((response) => {
      ...
      cell: (row) => (
        <div className="tb-odr-btns">
          ...
          <Button
            ...
            onClick={() => deleteModal("api/department/", row._id, updateData)}
          >
    ...
    <>
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>Department</BlockTitle>
              <BlockDes className="text-soft">Manage your Department</BlockDes>
            </BlockHeadContent>
            <BlockHeadContent>
