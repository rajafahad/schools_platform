...
const ExpandableRowComponent1 = ({ data }) => {
  return (
...
const ReactDataTable = ({ data, columns, pagination, actions, className, selectableRows, expandableRows ,fixedHeader, progressPending ,searchBy,expandableRowsComponent}) => {
