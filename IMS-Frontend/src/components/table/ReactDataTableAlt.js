...
import { DataTablePaginationAlt } from "../Component";
...
const Export = ({ data }) => {
  ...
  return (
    <React.Fragment>
      <div className="dt-export-buttons d-flex align-center pt-4 ps-4">
...
const ReactDataTableAlt = ({ data, columns, pagination, actions, className, selectableRows, expandableRows }) => {
  ...
  return (
    <div className={`dataTables_wrapper dt-bootstrap4 no-footer ${className ? className : ""}`}>
      <Row className={`justify-between g-2 ${actions ? "with-export" : ""}`}>
        <Col className="col-7 text-start ps-4 pe-4 pt-4" sm="4">
        ...
        <Col className="col-5 text-end " sm="8">
          <div className="datatable-filter ">
            <div className="d-flex justify-content-end g-2">
              ...
              <div className="dataTables_length pe-4 pt-4" id="DataTables_Table_0_length">
                <label>
      ...
      <DataTable
        data={tableData}
        columns={columns}
        className={"ps-sm-3 pe-sm-3 "+className}
...
export default ReactDataTableAlt;
